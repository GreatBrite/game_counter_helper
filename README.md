...
- Каждый день в 13:00 бот проверяет последние сообщения в канале
...
2. Создай файл `.env` на основе `env_example.txt` и заполни:
   - `BOT_TOKEN` - токен твоего бота от @BotFather
   - `CHANNEL_ID` - ID твоего канала (например @mychannel или -1001234567890)

3. Добавь бота в канал как администратора с правами на отправку сообщений
